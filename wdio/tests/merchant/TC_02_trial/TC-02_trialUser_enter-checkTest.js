    ...
    describe('SeamplessChex: TestCase: activeUser_enter-check: => ', function() {
        ...
        beforeEach(function (done) {
            ...
            it('should be visible fields label, input, checkbox, button in enter-check ', function () {
                ...
                assert.equal(checkboxSignatureActive, 'false', 'ERROR: checkbox Signature not TC_02_active in default =>>');
            ...
            it('should be check the form submission with valid fields Enter-check', function () {
                ...
                browser.pause(1000);
                browser.setValue('#address', 'Something street');
                browser.pause(1000);
                ...
                browser.pause(1000);
                browser.setValue('#memo', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam at rutrum ipsum.');
                ...
                browser.pause(2000);
                browser.setValue('#account_number', '22244');
                browser.pause(1000);
                browser.setValue('#confirm_account_number', '22244');
                browser.pause(4000);
            ...
            it('should be checking each field for validity Enter-check', function () {
                ...
                assert.include(routing_numberFieldNull, 'Please Enter Check Routing Number', 'there is no window with require message');
