describe('Seampless Test Case: NoPlanUser Merchant : =>', function() {
    ...
    it('Login account Merchant for NoPlan User ', function () {
    ...
    it('should be visible list menu for NoPlan user ', function () {
    ...
    it('should be click button "Send" in modal-window for NoPlan user ', function () {
