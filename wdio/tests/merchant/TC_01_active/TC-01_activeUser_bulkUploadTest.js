describe('SeamplessChex: TestCase: activeUser_bulkUpload: => ', function() {
    ...
    it('Login account for activeUser_bulkUpload ', function () {
    ...
    describe('SeamplessChex: TestCase: activeUser_bulkUpload: => ', function() {
        ...
        it('should visible title and buttons header in  activeUser_bulkUpload ', function () {
        ...
        it('should visible label, input type data and table with fields activeUser_bulkUpload ', function () {
        ...
        it('should visible label, input type data and table with fields for Upload History', function () {
            ...
            if (empty === 'List empty') {
                ...
                assert.notEqual(empty, 'List empty');
            }
        });
        ...
        it('should be uploading a file to the site for Bulk Upload', function () {
            ...
            browser.pause(3000);
            browser.waitForVisible('#upload_success', 1500);
            assert.equal( browser.getText('#upload_success'), 'File successfuly imported. See import details', 'ERROR: not visible alert');
        });
